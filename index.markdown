...
<div class="project-grid">
  ...
  <a class="project-card" href="/technologia_scope/">
    ...
    <div class="project-card-copy">
      ...
      <p>A real-time audiovisual playground driven by live audio analysis, Realtime CPU-based procedural graphics for low-end systems, controller input, and rapid visual experimentation.</p>
      <span class="project-link">View project →</span>
    </div>
  </a>
